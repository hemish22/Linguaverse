...
<style>
    ...
    /* SVG Tab Icons */
    button[data-baseweb="tab"]:nth-child(1) p::before {
        content: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%23134E8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>');
        display: inline-block; width: 18px; margin-right: 8px; vertical-align: middle;
    }
    button[data-baseweb="tab"]:nth-child(2) p::before {
        content: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%23134E8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>');
        display: inline-block; width: 18px; margin-right: 8px; vertical-align: middle;
    }
    button[data-baseweb="tab"]:nth-child(3) p::before {
        content: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="%23134E8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>');
        display: inline-block; width: 18px; margin-right: 8px; vertical-align: middle;
    }
...
tab_upload, tab_camera, tab_text = st.tabs(["Upload Image", "Capture from Camera", "Write Text Directly"])
